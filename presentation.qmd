...
author: "Datatude Dynamos- Kamaljeet Singh, Kaarthik Sai, Ayesha Khatun, Surya Vardhan Dama, Mrunali Yadav, Rajitha "
...
knitr::opts_chunk$set(
  ...
  dpi = 190             # higher dpi, sharper image
)
```
...
**How does the patterns in refugee populations evolved over time, and how have the stances of American political parties impacted these developments? Analyse the dynamics of refugee migrations towards US political environments.**

-   The fluctuation in refugee admissions from 2016 to 2018 under the Republican administration can be attributed to procedural carryover from previous policies, legal challenges to new policies, and ongoing humanitarian crises.

## Data Preparation and Pre-processing

-   Using the R dplyr package
-   Initially, we aggregate our data by year, categorizing it according to the political parties winning specific terms, followed by summarizing the overall number of refugees.

## Aim

The goal of our project is to illustrate the total number of refugees arriving in the United States over time. We will present a plot that highlights the periods during which either the Democratic Party or the Republican Party held power, taking into account the impact of external factors on these trends.
...
## Analysis 05: Refugee populations over time with US political context

::: panel-tabset
#### US political context Plot

![](images/anim_plot1.gif){fig-align="center" width="450" height="450"}

#### Study

-   Policy Lag and Bureaucratic Processes: Refugees admitted in the latter part of 2016 and into 2017 would have been under ceilings set by the previous administration
-   Global Humanitarian Crises: Increases in refugee admissions can also be in response to humanitarian crises.
-   The refugee approval process involves several rounds of background checks, screenings, and interviews that can take, on average, 18 to 24 months to complete.
:::
...
Our target dataset comes from the `Populations Dataset from {refugees} R package`, which compiles extensive information on populations that have been strongly displaced from three main sources: UNHCR, UNRWA, and IDMC.

-   "Population" dataset from [tidytuesday](https://github.com/rfordatascience/tidytuesday/blob/master/data/2023/2023-08-22/readme.md).
...
![](images/refugee_map_2012.jpg){fig-align="center" width="850" height="600"}

#### Plot 2012-2015

![](images/refugee_map_2016.jpg){fig-align="center" width="850" height="600"}
...
![](images/refugee_map_2018.jpg){fig-align="center" width="850" height="600"}

#### Plot 2017-2020

![](images/refugee_map_2020.jpg){fig-align="center" width="850" height="600"}
...
-   Climate change effects might begin to show, especially from countries suffering from environmental degradation.
:::
...
![](images/refugee_map_2022.jpg){fig-align="center" width="850" height="600"}
...
-   Economic downturns resulting from the pandemic might affect later refugee movements.
...
![](images/worldmap_plot.gif){fig-align="center" width="850" height="600"}
...
The refugee admissions in the United States have seen various fluctuations over the years due to a combination of U.S. policies and global circumstances. Following the historical high of 142,000 refugee admissions in 1993, in response to the Balkan wars, the ceiling ranged from 70,000 to 91,000 between 1999 and 2016. During the Obama administration, there was an increase to 85,000 in fiscal year 2016 and a proposed 110,000 in fiscal year 2017. However, the Trump administration made substantial cuts to these numbers, first lowering the FY 2017 cap from 110,000 to 50,000, then to even lower numbers in subsequent years, with only 15,000 for FY 2021 and actual admissions of fewer than 12,000 refugees in FY 2020.

## Question-2

From 2010 to 2022, the changing landscape of refugee migration to the USA was significantly shaped by war, economic crises, and policy shifts, with countries like Sudan experiencing profound outflows due to conflict and civil unrest, while external factors like climate change and global health emergencies further influenced these complex patterns.
