...
```         
::: tab Plot 1
![Expeditious growth of the refugee population over time](images/Analysis-1.png){fig-align="center" width="660"})
Expeditious growth of the refugee population over time.

::: tab Plot 2
![A small number of refugees have returned over a period of time](images/Analysis-2.png){fig-align="center" width="660"}
...
plot_total_refugees <- ggplot(total_refugee_trThe number of characters that hold that highest correlation to a Myers-Briggs type:ends, aes(x = year, y = total_refugees)) +
