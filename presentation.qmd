...
::: panel-tabset
    ::: tab Plot A
    ![The number of characters that hold the highest correlation to a respective Myers-Briggs personality type](images/Analysis-1.png){fig-align="center" width="660"}
    
    ::: tab Plot B
    ![The number of characters that hold that highest correlation to a Myers-Briggs type](images/Analysis-2.png){fig-align="center" width="750"}
