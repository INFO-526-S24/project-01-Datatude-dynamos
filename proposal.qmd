...
# Selecting the first 10 rows for the table
data_subset <- population[1:10, ]

# Creating the table with 'kable' and adding some basic styling with 'kableExtra'
styled_table <- kable(data_subset, "html") %>%
