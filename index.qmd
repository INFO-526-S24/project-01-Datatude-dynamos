...
author: 
  - name: "Datatude Dynamos -Kaarthik Sai, Kamaljeet Singh,  Surya Vardhan Dama, Ayesha Khatun, Mrunali Yadav, Rajitha"
    affiliations:
...
plot_top_countries <- ggplot(top_country_total_refugees, 
  ...
  labs(title = "Total Number of Refugees from Top 20 Countries",
       x = "Country of Origin", 
